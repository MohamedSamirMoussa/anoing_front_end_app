...
const Leaderboard = () => {
  ...
  return (
    <div className="leaderboard-container min-h-screen w-[95%] md:w-[80%] mx-auto py-20 px-4">
      <div className="py-10">
        <div className="tabs-container flex flex-col lg:flex-row justify-between items-center p-6 rounded-3xl bg-[#ffffff05] border border-[#ffffff10] gap-8 backdrop-blur-md">
          <div className="right ps-4">
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <span style={{ color: currentTheme.color }} className="font-orbitron font-bold text-lg">
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg font-orbitron text-[10px] md:text-xs uppercase transition-all duration-300 ${
                      isActive ? "text-white shadow-lg" : "text-[#ffffff50] hover:text-white"
                    }`}
                    style={{ background: isActive ? tabTheme.gradient : "transparent" }}
                  >
          ...
          return (
            <div key={user.id || index} className="player-card relative group">
              <div
                ...
                style={{ background: `linear-gradient(180deg, ${currentTheme.color}40, transparent)` }}
              >
                <div className="bg-[#0f0f0f] rounded-2xl p-5 flex flex-col gap-4">
                  <div className="header flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-white font-bold font-orbitron text-sm">{user.username}</h3>
                        <span
                    ...
                    >
                      {index < 3 && (
                        <span className="text-amber-400 mr-2 drop-shadow-[0_0_8px_rgba(251,191,36,0.4)]">
                          <FontAwesomeIcon icon={index === 0 ? faCrown : faMedal} />
                        </span>
                      )}
                      #{index + 1}
                    </span>
                  ...
                  <div className="body flex justify-between items-end">
                    <div className="playtime">
                      <p className="text-gray-500 text-[10px] uppercase tracking-widest mb-1">Total Playtime</p>
                      <p className="text-white font-orbitron text-lg font-bold">
                        {days > 0 ? `${days}d ` : ""}{hours}h {hours === 0 ? `${minutes}m` : ""}
                      </p>
                    </div>
                    <div className="status flex items-center gap-2 bg-black/20 px-3 py-1 rounded-full border border-white/5">
                      <span
                        ...
                        style={{ backgroundColor: user.is_online ? "#00ff00" : "#ff4444" }}
                      ></span>
